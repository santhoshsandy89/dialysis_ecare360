              ...
              child: Column(
                ...
                children: [
                  rowInput("Actual Blood Flow Rate (mL/min)",
                      controller: actualBloodFlowRateController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  rowInput("Total Blood Processed (mL)",
                      controller: totalBloodProcessedController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  rowInput("Dialyzer Type", controller: dialyzerTypeController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  rowInput("Arterial Pressure (mmHg)",
                      controller: arterialPressureController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  rowInput("Actual Dialysate Flow Rate (mL/min)",
                      controller: actualDialysateFlowRateController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  rowInput("Heparin Bolus (units)",
                      controller: heparinBolusController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  ...
                  rowInput("Venous Pressure (mmHg)",
                      controller: venousPressureController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  rowInput("Actual Ultrafiltration (mL)",
                      controller: actualUltrafiltrationController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  rowInput("Heparin Rate (units/hr)",
                      controller: heparinRateController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  rowInput("Needle Size (Gauge)",
                      controller: needleSizeController, readOnly: readOnly),
                  const SizedBox(height: 12),
                  rowInput("TMP (mmHg)", controller: tmpController, readOnly: readOnly),
                ],
              ),
            ),
          ),
